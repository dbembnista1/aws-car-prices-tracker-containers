...
variable "common_tags" {
  description = "Common tags applied to all resources. Environment is hardcoded per environment (this file lives only in environments/dev/bootstrap) and also drives the GitHub Environment name."
  type        = map(string)
  default = {
    Project     = "CarPrices"
    Environment = "dev"
